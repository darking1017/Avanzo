kv<!-- title: Prueba AVANZO | Arthur Martelli Gomes -->
...
- mística es un estado de perfección en el que el alma, purificada, se une con dios. En poesía su representante es san juan de la cruz y en prosa, santa teresa de jesús.
...
## Punto: 
- El punto y seguido finaliza una idea dentro del párrafo.
- El punto y aparte finaliza el párrafo dentro del texto.
- El punto final cierra la redacción de un texto.

## Coma:
- Separa dos o más palabras de una enumeración. Ejemplo: Acudió toda la familia: abuelos, padres, hijos, cuñados, etc.
- Separa un complemento que se antepone al sujeto. Ejemplo: Por la noche, los niños duermen.
- Aisla una oración explicativa que se intercala en una frase. Ejemplo: Ella es, entre todas las que llegaron, la más linda.
- Sustituye un verbo (elipsis verbal): A pedro le gusta el jamón; a juan, el tocino. Se ha sustituido el verbo gusta en la segunda oración.

## Punto y coma:
- Separa elementos en una oración en caso de que al menos uno de ellos lleve coma, Ejemplo: Norberto traerá la lechuga; Sofía, los tomates; Kenia, los rábanos, y Francisco, los pepinos.
...
## Dos puntos: 
- Antes de enumeración introducida por una palabra que engloba a todos los elementos. Ejemplo: Me gustas todos los cítricos: naranjas, limones, toronjas.
Para introducir una cita textual. Ejemplo: El filósofo avicena dijo: (En medicina debemos saber las causas de la salud y la enfermedad).

## Guion:
- Indica un intervalo. Ejemplos: Páginas 23-29, siglos XI-XII.
- En las palabras compuestas que denotan contraposición. Ejemplos: Lección teórico-Práctica.
- Las negociaciones jordano- sirias. También une nombre propios o conceptos opuestos. Ejemplos: Frontera Nicaragua- Honduras, la relación coste- beneficio.
- Une un prefijo con una palabra que inicia con mayúscula, una sigla o un número. Ejemplos: anti-hitler, sub-21, pro-OTAN.

## Paréntesis:
Cuando interrumpe para insertar una información complementaria o aclaratoria. Ejemplo: La reunión (que no pasó de las ocho) estuvo agitada. También para intercalar datos. Ejemplo: El año en que nació (1066) los normandos. Ejemplo: Allí se indicará(n) el(los) día(s) de entreno. En las acotaciones de obras teatrales. Ejemplo: REY. (de pie, enérgico) ¡Es hora de atacar!
...
## Extranjerismos:
Son palabras de otro idioma adaptadas al español. 

- Si la palabra extranjera incluye latinismos, se adapta a las normas del español, sin utilizar crusivas, y se le apican las reglas correspodientes. Ejemplos: Juego foot ball /juegos fútbol. me gusta el ballet / me gusta el balé, Hubo quorum /Hubo quórum.
- 
